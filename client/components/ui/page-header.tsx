...
export default function PageHeader({
    ...
    return (
        <div
            className={cn(
                'transition-all flex relative duration-300 left-1/2 -translate-x-1/2',
                isScrolled &&
                    'h-fit lg:max-w-4xl max-w-3xl p-4 items-center bg-background fixed md:top-20 bottom-20  shadow-sm rounded-full border-[0.5px] z-50 w-full',
            )}
        >
